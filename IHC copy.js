$(document).ready(function () {
    ...
    var content = [{
        ...
        title: "I Have Crush On You!!",
        desc: "maybe it's a fairly simple sentence, a sentence that holds a lot of hope and doubt behind it. there is hope that the feeling of liking will not fall alone, there is also something that must be prepared so that it can accept the consequences"
    }, {
       title: "",
       desc: "Expressing feelings is quite a serious thing, many will be sacrified including the end result of letting go of the things that have been stored for a long time is quite a relief and not an easy thing, here i just want to express my feeling for u, whether it is accepted or not depends of u, i wouldn't expect anything more either"
    }, {
        title: "",
        desc: "if  you're uncomfortable u can say to me, i have a crush on u, for example, if u already have a boyfriend, i'm sorry beause i've confessed to u... maybe that's all from me, hehe. thanks for reading."
    }, {
        title: "I Have Crush On You!!",
        desc: "i will waiting :)"
 }];
